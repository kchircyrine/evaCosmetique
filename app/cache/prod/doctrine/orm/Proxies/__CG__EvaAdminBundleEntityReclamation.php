 ...
 */
class Reclamation extends \Eva\AdminBundle\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Eva\\AdminBundle\\Entity\\Reclamation' . "\0" . 'subject', '' . "\0" . 'Eva\\AdminBundle\\Entity\\Reclamation' . "\0" . 'content', '' . "\0" . 'Eva\\AdminBundle\\Entity\\Reclamation' . "\0" . 'response', '' . "\0" . 'Eva\\AdminBundle\\Entity\\Reclamation' . "\0" . 'dateCreation', '' . "\0" . 'Eva\\AdminBundle\\Entity\\Reclamation' . "\0" . 'user'];
        }
