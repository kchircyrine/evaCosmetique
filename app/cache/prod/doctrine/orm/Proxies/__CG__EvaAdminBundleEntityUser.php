 ...
 */
class User extends \Eva\AdminBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Eva\\AdminBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'Eva\\AdminBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'Eva\\AdminBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'Eva\\AdminBundle\\Entity\\User' . "\0" . 'orders', '' . "\0" . 'Eva\\AdminBundle\\Entity\\User' . "\0" . 'address', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
