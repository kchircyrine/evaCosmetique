...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Eva\ClientBundle\Form\User\RegistrationFormType A Eva\ClientBundle\Form\User\RegistrationFormType instance.
     */
    protected function getAcmeUser_Registration_Form_TypeService()
    {
        return $this->services['acme_user.registration.form.type'] = new \Eva\ClientBundle\Form\User\RegistrationFormType('Eva\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'eva_cosmetique', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Eva\\AdminBundle\\Entity'))), 'Eva\\AdminBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('EvaAdminBundle' => 'Eva\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ba3d78c815063e420a212c6ef9a2cdb02b266d8f144aa19e4b5cddb507a4ae2f');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Eva\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('cyrine.kchir@gmail.com' => 'equipe Eva cosmétiques'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Eva\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Eva\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Eva\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Eva\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('noreply.presse@gmail.com');
        $a->setPassword('lapresse123');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Eva\\ClientBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Eva\\ClientBundle/Resources/translations\\security.fr.xlf'), 'fr', 'security');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Eva\\AdminBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Eva\\ClientBundle/Resources/views'), 'EvaClient');
        $instance->addPath(($this->targetDirs[3].'\\src\\Eva\\AdminBundle/Resources/views'), 'EvaAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EvaClientBundle' => 'Eva\\ClientBundle\\EvaClientBundle',
                'EvaAdminBundle' => 'Eva\\AdminBundle\\EvaAdminBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'eva_cosmetique',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'noreply.presse@gmail.com',
            'mailer_password' => 'lapresse123',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'noreply.presse@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'lapresse123',
            ...
            'fos_user.model.user.class' => 'Eva\\AdminBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'cyrine.kchir@gmail.com' => 'equipe Eva cosmétiques',
            ),
