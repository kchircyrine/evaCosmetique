...
use Eva\AdminBundle\Entity\Tag;
use Eva\AdminBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EvaAdminBundle:Tag')->findAll();

        return $this->render('EvaAdminBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EvaAdminBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EvaAdminBundle:Tag')->find($id);
        ...
        return $this->render('EvaAdminBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
        ));
    }
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EvaAdminBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    /**
     * Displays a form to delete an existing Tag entity.
     *
     */
    public function removeAction($id) {
        ...
        return $this->render('EvaAdminBundle:Tag:delete.html.twig', array(
                    'entity' => $entity,
